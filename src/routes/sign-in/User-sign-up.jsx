...
export default function UserSignUp() {
  return (
   ...
   <div className=' bg-slate-300 my-[10vh] shadow-2xl mx-auto max-w-sm  p-10 text-black rounded-lg '>
    <h1 className='font-serif text-center text-3xl mb-10'>SIGN IN</h1>
    <form action="" className='flex flex-col space-y-10 justify-center'>
        ...
        <div className='flex flex-col space-y-2'>
         ...
         <button type='submit' className='text-black font-semibold bg-gray-400 border-2 border-slate-900 py-2 px-3 rounded-full w-[250px]  hover:bg-slate-900 hover:text-white hover:cursor-pointer'>SIGN IN </button>
         </div>
    </form>
   </div>
