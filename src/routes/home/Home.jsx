...
const Home = () => {
    ...
    <div  className='grid   lg:grid-rows-2 items-center  gap-y-5   sm:gap-y-5  xl:grid-cols-2 space-x-10 md:mx-10 my-10'>
      ...
      <div className='grid grid-cols-2  space-x-5 '>
         <div className=' transition-colors duration-700 flex flex-col justify-between  bg-white p-5  text-black h-44 md:h-80 rounded-xl hover:bg-black hover:text-white   border-2 ' id='company'>
          <p className='text-xl   md:text-5xl font-bold max-w-[200px]'> LAPTOPS & COMPUTERS </p>
  ...
  <span class="opacity-0 group-hover:opacity-100 ">
    <ArrowForwardIcon/>
         ...
         <div className='transition-colors duration-700  flex flex-col justify-between   bg-white p-5  text-black h-44  md:h-80 rounded-xl hover:bg-black hover:text-white   border-2' id='company'>
          <p className='text-xl md:text-5xl font-bold max-w-[200px]'>MOBILES</p>
  ...
  <span class="opacity-0 group-hover:opacity-100 ">
    ...
    <div className='transition-colors duration-700 flex flex-row justify-between  items-center bg-white h-32 mt-5 py-3 px-4 text-black my-auto rounded-xl  hover:bg-black hover:text-white border-2' id='company'>
